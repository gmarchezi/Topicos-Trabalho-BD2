...
#### 5.3 DECISÕES DE PROJETO
    ...
    Modelo: em nosso projeto optamos por separar modelo do veiculo, pois a classe veiculo estava muito grande e isto poderia prejudicar a manutenibilidade do sistema.
